...
import com.example.noteappwithjetpackcompose.feature_note.domain.model.InvalidNoteException
...
class AddNote(private  val repository: NoteRepository) {
    ...
    suspend operator fun invoke(note: Note){
        ...
        throw InvalidNoteException("The title of note can not be empty")
        }
        if (note.content.isBlank()) {
        throw InvalidNoteException("The content of note can not be empty")
        }
